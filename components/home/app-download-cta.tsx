...
const APP_PERKS = [
  { icon: <Zap size={16} />, text: "Full access to Marketplace, Esports & Community" },
  { icon: <Bell size={16} />, text: "Push notifications for tournaments, deals & mentions" },
  { icon: <Shield size={16} />, text: "Secure payments with Paystack" },
];
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 px-6 sm:px-12 py-14 sm:py-16">
        ...
        <div className="flex flex-col justify-center">
          <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full border border-cyan/20 bg-cyan/5 w-fit">
            ...
            <span className="text-[11px] font-semibold text-cyan uppercase tracking-widest">Get the App</span>
          </div>
          ...
          <p className="text-text-muted text-sm sm:text-base leading-relaxed mb-8 max-w-md">
            The full CGE experience — tournaments, marketplace, and community — available
            on your phone. Download the app and join thousands of gamers across Africa.
          </p>
          ...
          <div className="flex flex-wrap gap-3">
            <a
              href="#"
              className="inline-flex items-center gap-3 px-5 py-3 rounded-xl bg-white/5 border border-border hover:border-cyan/40 hover:bg-cyan/5 transition-all group"
            >
              <svg viewBox="0 0 24 24" className="w-7 h-7 text-text group-hover:text-cyan transition-colors" fill="currentColor">
                <path d="M17.05 20.28c-.98.95-2.05.8-3.08.35-1.09-.46-2.09-.48-3.24 0-1.44.62-2.2.44-3.06-.35C2.79 15.25 3.51 7.59 9.05 7.31c1.35.07 2.29.74 3.08.8 1.18-.24 2.31-.93 3.57-.84 1.51.12 2.65.72 3.4 1.8-3.12 1.87-2.38 5.98.48 7.13-.57 1.5-1.31 2.99-2.54 4.09zM12.03 7.25c-.15-2.23 1.66-4.07 3.74-4.25.29 2.58-2.34 4.5-3.74 4.25z" />
              </svg>
              <div>
                <div className="text-[9px] text-text-muted uppercase tracking-wider leading-none">Download on the</div>
            ...
            >
              ...
              <div>
                <div className="text-[9px] text-text-muted uppercase tracking-wider leading-none">Get it on</div>
