...
import { Loader2, Trophy, AlertTriangle, Flag } from "lucide-react";
...
export function MatchReportModal({
  ...
  const canReport = (isParticipant || isHost) && match.status !== "completed" && match.status !== "bye";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          {isComplete && match.participant1_score !== null && (
        ...
        >
          ...
          {isComplete && match.participant2_score !== null && (
            <p className="text-2xl font-bold font-heading text-text mt-2">
