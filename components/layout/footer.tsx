        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-3 mt-4">
              ...
              <a
                href="https://tiktok.com/@caborsgaming"
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm text-text-muted">
              <p>
                <span className="text-text">Lounge (Mon–Sat):</span> {BRAND.hours.weekday}
              </p>
              <p>
                <span className="text-text">Lounge (Sunday):</span> {BRAND.hours.sunday}
              </p>
              <p className="text-xs mt-1" style={{ color: "#C4C4CC" }}>
              ...
              <Badge color="magenta" size="sm" className="w-fit mt-2">
                Ages {BRAND.agePolicy} Only
              </Badge>
            </div>
          </div>
        </div>
